...
public class StudijskiProgramServiceImpl implements StudijskiProgramService {
    ...
    @Autowired
    public StudijskiProgramServiceImpl(StudijskiProgramRepository spRepository, StudijskiProgramMapper predmetMapper, FakultetService fakultetService, NivoStudijaService nsService, NivoStudijaMapper nivoStudijaMapper, PozicijaRepository pozicijaRepository) {
